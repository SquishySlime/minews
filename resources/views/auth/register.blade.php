...
<div class="container-fluid py-5">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <h1 class="mb-4 fw-bold text-start">Register</h1>

            <form method="POST" action="{{ route('register') }}" class="mb-3 bg-white p-4 shadow-sm rounded-3">
                @csrf
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <a href="{{ route('socialite.redirect', 'github') }}" class="btn btn-dark w-100">
                            <i class="fab fa-github me-2"></i> Daftar dengan Github
                        </a>
                    </div>
                </div>
            </div>
